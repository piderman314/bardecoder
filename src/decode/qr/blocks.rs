...
fn alignment_location(version: u32) -> Result<AlignmentLocation, QRError> {
    match version {
        ...
        21 => Ok(AlignmentLocation::new(28, 22)),
        22 => Ok(AlignmentLocation::new(26, 24)),
        23 => Ok(AlignmentLocation::new(30, 24)),
        24 => Ok(AlignmentLocation::new(28, 26)),
        25 => Ok(AlignmentLocation::new(32, 26)),
        26 => Ok(AlignmentLocation::new(30, 28)),
        27 => Ok(AlignmentLocation::new(34, 28)),
        28 => Ok(AlignmentLocation::new(26, 24)),
        29 => Ok(AlignmentLocation::new(30, 24)),
        30 => Ok(AlignmentLocation::new(26, 26)),
        31 => Ok(AlignmentLocation::new(30, 26)),
        32 => Ok(AlignmentLocation::new(34, 26)),
        33 => Ok(AlignmentLocation::new(30, 28)),
        34 => Ok(AlignmentLocation::new(34, 28)),
        35 => Ok(AlignmentLocation::new(30, 24)),
        36 => Ok(AlignmentLocation::new(24, 26)),
        37 => Ok(AlignmentLocation::new(28, 26)),
        38 => Ok(AlignmentLocation::new(32, 26)),
        39 => Ok(AlignmentLocation::new(26, 28)),
        40 => Ok(AlignmentLocation::new(30, 28)),
        _ => Err(QRError {
            msg: format!("No alignment information for version {}", version),
        }),
    }
}
